...
void* const gMPlayJumpTableTemplate[] = {
    ...
    ply_port,  ply_fine,  ply_endtie, SampleFreqSet, TrackStop, FadeOutBody, TrkVolPitSet, ClearChain, SoundMainBTM,
};
...
const XcmdFunc gXcmdTable[] = { ply_xxx,   ply_xwave, ply_xtype, ply_xxx,   ply_xatta, ply_xdeca,
