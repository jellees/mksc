...
_08030318:
    ...
    str r4, [r7, #0x04]
    ldr r1, [r6, #0x0C]
    ldr r0, _0803034C @ =0xFFFF0000
    ands r1, r0
    adds r0, r2, #0x0
    mov r7, r9
    asrs r0, r7
    ldr r7, _08030348 @ =0x0000FFFF
    ands r0, r7
    orrs r1, r0
    mov r0, r10
    str r1, [r0, #0x08]
    ...
    beq _08030354
    b _08030356
_08030344: .4byte 0x040000D4
_08030348: .4byte 0x0000FFFF
_0803034C: .4byte 0xFFFF0000
_08030350:
    adds r5, r5, r2
    b _08030356
_08030354:
...
_08030386:
    ...
    pop {r0}
    bx r0
    thumb_func_start sub_803039C
sub_803039C:
    push {r4, lr}
    adds r4, r0, #0x0
    adds r0, #0x08
    ldr r1, _080303BC @ =0x030048A0
    movs r2, #0xC0
    lsls r2, r2, #0x03
    bl frmheap_init
    movs r0, #0x00
    ...
    bx r0
    .byte 0x00, 0x00
_080303BC: .4byte 0x030048A0
    thumb_func_start sub_80303C0
sub_80303C0:
    push {r4, r5, lr}
    adds r4, r0, #0x0
    movs r0, #0x01
...
_08030438: .4byte 0x03002190
    .byte 0x01, 0x1C, 0x48, 0x69, 0x00, 0x28, 0x01, 0xD0, 0x00, 0x20, 0x01, 0xE0, 0x01, 0x20, 0x48, 0x61
    .byte 0x70, 0x47, 0x00, 0x00, 0x00, 0x21, 0x41, 0x61, 0x70, 0x47, 0x00, 0x00
    thumb_func_start vcount_init
vcount_init: @ 08030458
    push {r4, lr}
    ldr r1, _0803048C @ =0x04000004
    ldrb r0, [r1, #0x01]
    movs r3, #0x00
    strb r3, [r1, #0x01]
    ldrb r2, [r1, #0x00]
    ...
    ands r0, r2
    strb r0, [r1, #0x00]
    ldr r4, _08030490 @ =0x03004FC0
    str r3, [r4, #0x14]
    adds r0, r4, #0x0
    adds r0, #0x08
    ldr r1, _08030494 @ =0x03002D20
    movs r2, #0x80
    lsls r2, r2, #0x01
    bl frmheap_init
    adds r0, r4, #0x0
    ...
    bx r0
    .byte 0x00, 0x00
_0803048C: .4byte 0x04000004
_08030490: .4byte 0x03004FC0
_08030494: .4byte 0x03002D20
    thumb_func_start vcount_reset
vcount_reset: @ 08030498
    push {r4, lr}
    ldr r1, _080304C4 @ =0x04000004
    ldrb r0, [r1, #0x01]
    movs r3, #0x00
    strb r3, [r1, #0x01]
    ldrb r2, [r1, #0x00]
    ...
    pop {r0}
    bx r0
_080304C4: .4byte 0x04000004
_080304C8: .4byte 0x03004FC0
    thumb_func_start vcount_register
vcount_register: @ 080304CC
    push {r4, r5, r6, r7, lr}
    adds r4, r0, #0x0
    adds r6, r1, #0x0
    ldr r7, _080304F4 @ =0x03004FC8
    adds r0, r7, #0x0
    movs r1, #0x01
    movs r2, #0x10
    bl frmheap_calloc
    ...
    b _080304FE
    .byte 0x00, 0x00
_080304F4: .4byte 0x03004FC8
_080304F8:
    ldr r0, _08030514 @ =0x03004FC0
    bl list_getNext
_080304FE:
    adds r1, r0, #0x0
    cmp r1, #0x00
    ...
    ldr r0, _08030514 @ =0x03004FC0
    adds r2, r5, #0x0
    bl list_insertBefore
    b _08030520
_08030514: .4byte 0x03004FC0
_08030518:
    ldr r0, _08030544 @ =0x03004FC0
    adds r1, r5, #0x0
    bl list_insertTail
_08030520:
    ldr r4, _08030544 @ =0x03004FC0
    adds r0, r4, #0x0
    bl list_getHead
    ldr r2, _08030548 @ =0x04000004
    str r0, [r4, #0x14]
    ldr r0, [r0, #0x08]
    ldrb r1, [r2, #0x01]
    strb r0, [r2, #0x01]
...
_0803053A:
    ...
    bx r1
    .byte 0x00, 0x00
_08030544: .4byte 0x03004FC0
_08030548: .4byte 0x04000004
    thumb_func_start vcount_unregister
vcount_unregister: @ 0803054C
    push {lr}
    adds r1, r0, #0x0
    ldr r0, _0803055C @ =0x03004FC0
    bl list_remove
    pop {r0}
    bx r0
    .byte 0x00, 0x00
_0803055C: .4byte 0x03004FC0
    thumb_func_start vcount_irqHandler
vcount_irqHandler: @ 08030560
    push {r4, r5, lr}
    ldr r5, _0803059C @ =0x03004FC0
    ldr r4, [r5, #0x14]
    ldr r0, [r4, #0x0C]
    bl _call_via_r0
    adds r0, r5, #0x0
...
_08030582:
    ...
    bx r0
    .byte 0x00, 0x00
_0803059C: .4byte 0x03004FC0
_080305A0: .4byte 0x04000004
